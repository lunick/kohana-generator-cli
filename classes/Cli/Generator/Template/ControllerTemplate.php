 ...
 *
 */
final class Cli_Generator_Template_ControllerTemplate extends Cli_Generator_Abstract_Controller {
        
    private $template = "templates/layout";
    ...
    public function init(){
        ...
        $writer->set_dir(controller_dir().upper_first($this->get_subdir()).DIRECTORY_SEPARATOR)
                    ...
                    ->php_head_enable()
                    ->add_row("class Controller_" . 
                            path_to_class(clean_path($this->get_subdir().DIRECTORY_SEPARATOR.$this->get_options_obj()->name)) . 
                            " extends Controller_Template {")
                    ->add_row()
                    ->add_row()
                    ->add_row("public \$template = '".$this->template."';", 4)
                    ->add_row();
