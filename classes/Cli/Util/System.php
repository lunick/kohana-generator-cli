    ...
    public static function paths($num){
        switch ($num){
            ...
            case self::$CONTROLLER :
                return DOCROOT."application". DIRECTORY_SEPARATOR . "classes" . DIRECTORY_SEPARATOR . Cli_Util_Text::name("Controller") . DIRECTORY_SEPARATOR;
            break;
            
            case self::$MODEL :
                return DOCROOT."application". DIRECTORY_SEPARATOR . "classes" . DIRECTORY_SEPARATOR . Cli_Util_Text::name("Model") . DIRECTORY_SEPARATOR;
            break;
