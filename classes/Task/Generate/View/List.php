 ...
 *
 */
class Task_Generate_View_List extends Minion_Task {
    ...
    protected function _execute(array $params) {
        ...
        $dir = empty($params['dir']) ? "lists" : strtolower($params['dir']).DIRECTORY_SEPARATOR."lists";
        ...
        if($all && empty($table))
        {
            ...
            foreach ($tables as $table){
                try{
                    Generator_File_Writer::factory(new Generator_Item_List($table))
