 ...
 *
 */
class Generator_Database_Table {
    ...
    {
        $this->config = Generator_Util_ConfigReader::get_config();
        $this->table = $table;
    ...
    {
        return new Generator_Database_Table($table);
    }
    ...
    private function name($table, $db_name = true) 
    {
        if ($db_name) 
        {
            ...
            {
                return Generator_Service_AutoDetect::table_names_plural() ? strtolower(Inflector::singular($table)) : strtolower($table);
            }
        }
        else 
        {
    ...
    public function get_table_fields()
    {
        ...
        foreach ($fields as $array) {
            $list[] = Generator_Database_Field::factory($array);
        }
